...
if(d.defaultErrorDisp){a.bind("inputcheck",function(i,h){d.setErrorMesssage($(this),h);});}return a;}});(function(a){a(document).ready(function(){a('[data-role*="validation"]').each(function(){a(this).validate();
